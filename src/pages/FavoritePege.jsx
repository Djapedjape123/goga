...
function FavoritePege() {
  ...
  return (
    <>
      {/* 👇 DODATO: SEO KOMPONENTA ZA FAVORITE 👇 */}
      <SEO 
        title={t('favorites_page.seo_title', { defaultValue: "Omiljene Mašine | Masine.ai" })}
        description={t('favorites_page.seo_desc', { defaultValue: "Pregledajte mašine koje ste sačuvali. Vaša personalizovana lista građevinske i poljoprivredne mehanizacije." })}
      />
